...
DROP INDEX "days_user_day_idx";--> statement-breakpoint
...
DROP INDEX "push_subscriptions_user_endpoint_idx";--> statement-breakpoint
DROP INDEX "push_subscriptions_endpoint_idx";--> statement-breakpoint
DROP INDEX "routine_exercises_user_label_idx";--> statement-breakpoint
DROP INDEX "routine_slots_user_weekday_idx";--> statement-breakpoint
...
ALTER TABLE `profiles` ALTER COLUMN "protein_target" TO "protein_target" real;--> statement-breakpoint
...
ALTER TABLE `profiles` ALTER COLUMN "fat_min" TO "fat_min" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "fat_max" TO "fat_max" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "fat_floor" TO "fat_floor" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "carbs_gym" TO "carbs_gym" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "carbs_rest" TO "carbs_rest" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "calories_target" TO "calories_target" real;--> statement-breakpoint
ALTER TABLE `profiles` ALTER COLUMN "calories_rest" TO "calories_rest" real;